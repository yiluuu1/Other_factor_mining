...
class SymbolicRegressor(BaseSymbolic, RegressorMixin):
    ...
    metric : str, optional (default='mean absolute error')
        The name of the fitness metric. Available options include:
    ...
    parsimony_coefficient : float or "auto", optional (default=0.001)
        ...
        a less understandable final gp_results. This parameter may need to be tuned
    ...
    low_memory : bool, optional (default=False)
        ...
        generations, this can gp_results in substantial memory use reduction.
...
class SymbolicClassifier(BaseSymbolic, ClassifierMixin):
    ...
    transformer : str, optional (default='sigmoid')
        The name of the function through which the  decision function is
        passed. This function will transform the decision function into
    ...
    class_weight : dict, 'balanced' or None, optional (default=None)
        ...
        weights inversely proportional to class frequencies in the input supply_demand_data
